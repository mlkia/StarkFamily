...
namespace StarkFamily.Controllers
{
    public class PersonsController : Controller
    {
        ...
        {
            var familyContext = _context.Personos.Include(p => p.Father);
            return View(await familyContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,BirthDate,DeathDate,FatherId")] Person person)
        {
            ...
            ViewData["FatherId"] = new SelectList(_context.Personos, "Id", "Id", person.FatherId);
            return View(person);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,BirthDate,DeathDate,FatherId")] Person person)
        {
            if (id != person.Id)
            {
                return NotFound();
